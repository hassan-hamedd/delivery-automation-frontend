...
const demoLayouts = [
    {
        name: 'Light Sidebar',
        thumbnail: 'src/assets/images/screenshots/layout1-customizer.png',
        isPro: false,
        options: {
    ...
    },
    {
        ...
        thumbnail: 'src/assets/images/screenshots/layout5-customizer.png',
        isPro: false,
        options: {
            activeLayout: 'layout1',
            activeTheme: 'blue',
    ...
    {
        name: 'Dark Sidebar',
        thumbnail: 'src/assets/images/screenshots/layout1-blue-customizer.png',
        isPro: false,
        options: {
            activeLayout: 'layout1',
            activeTheme: 'blue',
